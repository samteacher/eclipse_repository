...
public class TmConstant {
    ...
    public static final String PUBLISH = "<label class='tm_status' style='color:green'>已发布</label>";
    public static final String UN_PUBLISH = "<label class='tm_status' style='color:red'>待发布<label>";
    
    public static final String CONTENT_STATIC = "<label class='tm_static' style='color:green'>已静态</label>";
    public static final String CONTENT_UN_STATIC = "<label class='tm_static' style='color:red'>未静态<label>";
    
    public static final String CONTENT_TOP = "<label class='tm_top' style='color:green'>已置顶</label>";
    public static final String CONTENT_UN_TOP = "<label class='tm_top' style='color:red'>未置顶<label>";
    
    public static final String CONTENT_COMMENT = "<label class='tm_comment' style='color:green'>是</label>";
    public static final String CONTENT_UN_COMMENT = "<label class='tm_comment' style='color:red'>否<label>";
    
    public static final String FFMPET_PATH = "WEB-INF/plugin/ffmpeg/ffmpeg.exe";
    public static final String FFMPET_VIDEO_IMAGE_PATH = "resource/video/image/";
