...
<html>
  ...
  <body>
  	<div id="box">
  		<form id="userForm" action="${rootPath}/user/save.html" method="post">
	  		...
	  		<p>生日:<input type="text" name="time" placeholder="请输入电话.." value="2012-11-12"/></p>
	  		...
	  		<p>是否删除:
	  			<label><input type="radio" name="isDelete" checked="checked" value="1"/>是</label>
	  			<label><input type="radio" name="isDelete" value="0"/>否</label>
	  		</p>
	  		<p>描述 :
...
//   			});
  				...
  				//方法三:
  	  			...
  	  			$.ajax({
  	  				type:"post",
  	  				url:basePath+"/user/ajaxSave.html",
  	  				data:params,
  	  				success:function(data){
