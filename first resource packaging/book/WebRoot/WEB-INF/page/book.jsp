<%@page import="com.moov.dao.log.MoLogDao"%>
...
<div id="container">
     <div class="con_left">
          ...
          <div class="conl_nr">
               <div class="time"><p>${hashMap.createtime}</p></div>
               <div class="conl_bt"><a href="../page/comment?id=${hashMap.id}">${hashMap.title}</a></div>
               <div class="conl_zi"><p>${hashMap.content}</p><p></p></div>
               <div class="conl_btn">
